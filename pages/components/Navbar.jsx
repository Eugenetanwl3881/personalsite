...
import { AiOutlineMenu, AiOutlineClose, AiOutlineCode } from "react-icons/ai";
import {
  FaEnvelope,
  FaGithub,
  FaLinkedin,
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        <Link href="/">
          <AiOutlineCode size={70} className="left-0 top-0" />
        </Link>
      ...
      <div
        className={
          nav
            ? "md:hidden fixed left-0 top-0 w-full h-screen bg-[#00FFFF]/70"
            : ""
        }
      >
        <div
        ...
        >
          ...
          <div className="py-4 flex-col">
            ...
            <div className="pt-40">
              <p className="uppercase tracking-widest text-[#0000FF]">
                Connect with me
              </p>
